...
class BackingLayer: Binder {
	...
	enum Binding: BackingLayerBinding {
		...
		case mask(DynamicValue<LayerConvertible?>)
		case sublayers(DynamicValue<[LayerConvertible]>)
...
extension BindingName where Binding: BackingLayerBinding {
	...
	static var mask: BindingName<DynamicValue<LayerConvertible?>, Binding> { return BindingName<DynamicValue<LayerConvertible?>, Binding>({ v in .backingLayerBinding(BackingLayer.Binding.mask(v)) }) }
	static var sublayers: BindingName<DynamicValue<[LayerConvertible]>, Binding> { return BindingName<DynamicValue<[LayerConvertible]>, Binding>({ v in .backingLayerBinding(BackingLayer.Binding.sublayers(v)) }) }
	#if os(macOS)
...
class GradientLayer: ConstructingBinder, GradientLayerConvertible {
	...
	var uiGradientLayer: Instance { return instance() }
...
protocol GradientLayerConvertible: LayerConvertible {
	var uiGradientLayer: GradientLayer.Instance { get }
}
...
extension GradientLayer.Instance: GradientLayerConvertible {
	var uiGradientLayer: GradientLayer.Instance { return self }
}
...
#if os(macOS)
	var nsView: View.Instance { return wkWebView }
#else
	var uiView: View.Instance { return wkWebView }
#endif
}
...
class StackView: ConstructingBinder, StackViewConvertible {
	...
	#if os(macOS)
		var nsStackView: Instance { return instance() }
	#else
		var uiStackView: Instance { return instance() }
	#endif
	...
	enum Binding: StackViewBinding {
		...
		case views(DynamicValue<[ViewConvertible]>)
		#if os(macOS)
...
extension BindingName where Binding: StackViewBinding {
	...
	static var views: BindingName<DynamicValue<[ViewConvertible]>, Binding> { return BindingName<DynamicValue<[ViewConvertible]>, Binding>({ v in .stackViewBinding(StackView.Binding.views(v)) }) }
	#if os(macOS)
	...
	protocol StackViewConvertible: ViewConvertible {
		var nsStackView: StackView.Instance { get }
	}
	extension StackViewConvertible {
		var nsView: View.Instance { return nsStackView }
	}
	extension StackView.Instance: StackViewConvertible {
		var nsStackView: StackView.Instance { return self }
	}
#else
	protocol StackViewConvertible: ViewConvertible {
		var uiStackView: StackView.Instance { get }
	}
	extension StackViewConvertible {
		var uiView: View.Instance { return uiStackView }
	}
	extension StackView.Instance: StackViewConvertible {
		var uiStackView: StackView.Instance { return self }
	}
#endif
